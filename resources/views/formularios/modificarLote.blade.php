...
<form action="{{  route('update.lote',$lote->id) }} " method="POST">
    @csrf
    @method('PUT')
    <div class="container-md text-center mt-4">
            <h1 style="color: green; font-family: Arial, sans-serif; font-size: 30px; font-weight: bold;">Modificar Lote</h1>
            ...
            <section class="shadow-lg p-3 mb-5 bg-body-tertiary rounded mt-4">
                <div class="container-md text-center">
                    ...
                    <div class="contaniner-lg row align-items-start">
                        <div class="col">
                            <div class="col form-floating mb-3">
                                <input type="text"
                                    ...
                                    class="form-control" 
                                    id="nombreLote"
                                    style="--bs-focus-ring-color: rgba(var(--bs-success-rgb), .25)" value="{{$lote->nombreLote}}">
                        ...
                        <div class="col">
                            <div class="col form-floating mb-3">
                                <input type="text" name="area" class="form-control" id="areaLote" value="{{$lote->area}}" 
                    ...
                    <div style="text-align: center;" class="mt-4">
                        <button type="submit" class="btn btn-primary" style="background-color: #7DAF49; border: 2px solid #7DAF49;">Modificar Lote</button>
                    </div>  
                </div>
            </section>
